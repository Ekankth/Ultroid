...
**Ultroid [v{ultroid_version}](https://github.com/Anekashastrahasta/Ultroid), powered by @AnekaShastraHasta**
"""
...
async def ultroid(event):
    ...
    if event.sender_id not in SUDO_M.fullsudos:
        ...
        if not udB.get_key("STARTMSG"):
            ...
            await event.reply(
                f"Hey there {mention}, this is AnekaShastraHasta Assistant of {me}!\n\n{ok}",
